...
printf("================>yk debug hdisplay=%d, vdisplay:%d, vrefresh:%d, type:%d=>%d, connector_id=%d\n",
		tmp_m->hdisplay, tmp_m->vdisplay, tmp_m->vrefresh, tmp_m->type, DRM_MODE_TYPE_PREFERRED, c->connector_id);
